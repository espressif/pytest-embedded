...
#
# This file is copied from ESP-IDF repo, and used for testing only.
# Please refer to https://github.com/espressif/esp-idf/blob/release/v4.3/components/partition_table/gen_esp32part.py
