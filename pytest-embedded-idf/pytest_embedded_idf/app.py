...
class IdfApp(App):
    ...
    :ivar: binary_path: binary file path
    :ivar: elf_file: elf file path
    :ivar: parttool_path: partition tool path
    :ivar: sdkconfig: dict contains all k-v pairs from the sdkconfig file
    :ivar: flash_files: list of (offset, file path, encrypted) of files need to be flashed in
