...
from pytest_embedded import App, Dut
...
buff_parametrized_fixtures = {}


def set_buff_parametrized_fixtures(values: t.Dict):
    global buff_parametrized_fixtures
    buff_parametrized_fixtures = values.copy()
...
class DutFactory:
    ...
    def create(
        ...
        *,
        ...
        esptool_baud=None,
        part_tool=None,
        confirm_target_elf_sha256=None,
        erase_nvs=None,
        skip_check_coredump=None,
        panic_output_decode_script=None,
        openocd_prog_path=None,
        openocd_cli_args=None,
        gdb_prog_path=None,
        gdb_cli_args=None,
        no_gdb=None,
        qemu_image_path=None,
        qemu_prog_path=None,
        qemu_cli_args=None,
        qemu_extra_args=None,
        wokwi_cli_path=None,
        skip_regenerate_image=None,
        encrypt=None,
        keyfile=None,
    ):
        layout = []
        try:
            ...
            _pexpect_logfile = os.path.join(
                buff_parametrized_fixtures['_meta'].logdir, f'custom-dut-{dut_global_index}.txt'
            )
            logging.warning('You can get your custom DUT log file at the following path: %s.', _pexpect_logfile)
            ...
            _kwargs = {
                ...
                'keyfile': keyfile,
                # common
                'test_case_name': buff_parametrized_fixtures['test_case_name'],
                '_meta': buff_parametrized_fixtures['_meta'],
                # pre-initialized fixtures
